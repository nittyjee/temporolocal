(function(window) {
  ...
  L.Map.prototype.removeHash = function() {
    ...
    var canvasTiles = new L.TileLayer.Canvas( {tms: false, minZoom: 9, maxZoom: 16, attribution: bagatttr});
...
canvasTiles.drawTile = function(canvas, tilePoint, zoom) {
  ...
  var url = 'https://api.mapbox.com/styles/v1/nittyjee/cj81xi6ij92pl2qld6s4ld01e/tiles/256/'+zoom+'/'+tilePoint.x+'/'+tilePoint.y+'?access_token=pk.eyJ1Ijoibml0dHlqZWUiLCJhIjoid1RmLXpycyJ9.NFk875-Fe6hoRCkGciG8yQ';
...
$('#linkButton').on('click', function(){
  ...
  document.location.href = 'v1.2.html' + urlHash;
})
